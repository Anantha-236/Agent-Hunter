...
_MODULE_ALIASES: Dict[str, str] = {
    ...
    "lfi": "lfi_rfi_scanner",
    "rfi": "lfi_rfi_scanner",
    "file inclusion": "lfi_rfi_scanner",
    "lfi rfi": "lfi_rfi_scanner",
    "misconfig": "misconfig_scanner",
    "misconfiguration": "misconfig_scanner",
    "cors": "cors_scanner",
    "jwt": "jwt_scanner",
    "security headers": "header_security",
    "header security": "header_security",
    "rate limit": "rate_limit_scanner",
    "rate limiting": "rate_limit_scanner",
    "sensitive data exposure": "sensitive_data_exposure",
    "secret exposure": "sensitive_data_exposure",
    "tls": "ssl_tls_scanner",
    "ssl": "ssl_tls_scanner",
